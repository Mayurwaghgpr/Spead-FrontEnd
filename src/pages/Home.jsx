...
function Home() {
  ...
  return (
    <main className="">
      <div className="flex transition-all duration-1000   justify-center  items-center mt-20 px-10 sm:py-24 sm:mb-1 mb-16  py-10 text-start w-full ">
        <div className=" container flex flex-col  px-3 sm:w-1/2 h-full justify-center  break-words ">
          ...
          <div className="w-full flex justify-center sm:px-5">
            <Link
              to="/write"
              className="bg-white  py-2 px-4 rounded-full hover:bg-slate-200 border-2 border-black z-0  transition-all duration-300 "
            >
              Get Started
            </Link>
          </div>
      ...
      <div className={"w-full sm:px-15 lg:px-20 flex items-start mb-20 "}>
        <article
          id="homeArtical"
          className={` flex sm:justify-evenly  items-center   w-full  flex-col h-full rounded-xl z-10`}
        >
          <div
          ...
          <div className="flex flex-col gap-3 h-full  justify-center items-center w-full px-3  rounded-e-xl">
            <div className="flex justify-between items-center  text-gray-300 font-light  bg-white border  sm:w-1/2  transition-all duration-500  hover:scale-105 rounded-xl shadow">
              <SearchBar className={"w-full block"} />
            </div>{" "}
            <div className="shadow-lg flext justify-center items-center rounded-2xl  w-full max-w-[800px]  bg-white  ">
              <img
                className=" sm:object-cover  object-center  w-full rounded-2xl"
                src={image}
                alt=""
              />
            </div>
