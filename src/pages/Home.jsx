  ...
  return (
    <>
      <main className="relative">
        <div className="relative min-h-[40rem] flex justify-center items-center px-10 sm:py-24 sm:mb-1 py-10 text-start h-full">
          <motion.video
          ...
          <div className="container flex flex-col px-3 xl:w-1/2 lg:w-[60%] justify-center break-words relative">
            <div className="bg-white p-7 rounded-lg bg-opacity-50 backdrop-blur-lg flex flex-col gap-2">
              ...
              <div className="w-full flex justify-center py-4">
                <Link
                  to="/write"
                  className="sm:py-2 px-4 text-inherit text-sm rounded-full bg-gray-200 border-2 z-0 transition-all duration-300"
                >
                  Get Started
                </Link>
              </div>
