...
function InputTypeSelector({ imageInputRef, addElement, handleFileChange }) {
  ...
  return (
    <div
      className={`flex gap-2 absolute pointer-events-none  left-9 justify-center px-5 items-end transition-all duration-500 *:pointer-events-auto ease-in-out font-thin *:h-[2.5rem] *:w-[2.5rem] *:border *:rounded-full *:border-slate-500 text-slate-600 `}
    >
